    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (test) {
                ...
                getServletContext().getRequestDispatcher("/pageET.jsp").forward(request, response);
            }
            if (test2) {

                getServletContext().getRequestDispatcher("/pageAd.jsp").forward(request, response);
            }
